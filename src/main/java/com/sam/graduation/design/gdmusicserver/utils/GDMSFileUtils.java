 ...
 *
 */
package com.sam.graduation.design.gdmusicserver.utils;
...
public class GDMSFileUtils {
    ...
    public static String moveItemPackage(MultipartFile srcFile, String itemPackageRootPath, Long userID) {
        ...
        if (desFile != null && desFile.exists()) {
            org.apache.commons.io.FileUtils.deleteQuietly(desFile);
        } else {
        }
        ...
        // 移动
        try {
            org.apache.commons.io.FileUtils.copyToFile(srcFile.getInputStream(), desFile);
